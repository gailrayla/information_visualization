console.log("hello World!") // We encourage you to utilize console.log() and console frequently!
...
Tasks
1. Filter out data which contain null values
2. Parse time data 
3. Sort data in chronological order
